...
void Object::initialize(string filePath, string texturePath, Shader* shader, glm::vec3 position, glm::vec3 scale, float angle, glm::vec3 axis)
{
...
void Object::loadObj(string filePath, string texturePath)
{
	//"Gambiarra provisõria"
	string texNomes[] = {texturePath};
	int i = 0;
